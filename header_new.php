...
<div class="w3-top">
    <div class="w3-bar w3-black w3-card w3-left-align w3-small">
        ...
        <div class="nav-login">
            <?php
            /* if the user is logged in (check is session id is set), 
             * create a User Account button for 
            ...
            if (isset($_SESSION['u_id'])) {
                ...
                </form> <?php echo '<form action = "/php_includes/db_logout.inc.php" method = "POST">' ?>
